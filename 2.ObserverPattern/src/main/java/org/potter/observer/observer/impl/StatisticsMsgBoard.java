...
public class StatisticsMsgBoard implements Observer, DisplayElement {
    private float temperature;
    private float humidity;
    private float pressure;
    private Subject weatherData;

    public StatisticsMsgBoard(Subject weatherData) {
    ...
    @Override
    public void display() {
        System.out.println("statistics value: " + temperature + ", " + humidity + ", " + pressure);
    }
