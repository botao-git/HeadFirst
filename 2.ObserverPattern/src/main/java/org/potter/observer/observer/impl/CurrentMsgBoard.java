...
public class CurrentMsgBoard implements Observer, DisplayElement {
    private float temperature;
    private float humidity;
    private float pressure;
    private Subject weatherData;

    public CurrentMsgBoard(Subject weatherData) {
    ...
    @Override
    public void display() {
        System.out.println("current value: " + temperature + ", " + humidity + ", " + pressure);
    }
